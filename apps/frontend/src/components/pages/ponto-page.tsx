                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-muted/50 border-b text-muted-foreground font-bold uppercase tracking-wider">
                      ...
                      <th className="p-4">Justificativas / Ajustes</th>
                  ...
                  <tbody className="divide-y divide-border">
                    {myRecords.map((r) => (
                      <tr key={r.id} className="hover:bg-muted/10 transition-colors">
                        ...
                        <td className="p-4 font-semibold text-emerald-500">{formatTime(r.entrada)}</td>
                        <td className="p-4 font-semibold text-red-500">{formatTime(r.saida)}</td>
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-muted/50 border-b text-muted-foreground font-bold uppercase tracking-wider">
                    ...
                    <th className="p-4">Ajustes / Histórico</th>
                    <th className="p-4">Status</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-border">
                  {filteredHistory.map((r) => (
                    <tr key={r.id} className="hover:bg-muted/10 transition-colors">
                      ...
                      <td className="p-4 font-semibold text-emerald-500">{formatTime(r.entrada)}</td>
                      <td className="p-4 font-semibold text-red-500">{formatTime(r.saida)}</td>
                      <td className="p-4 text-muted-foreground text-[10px] space-y-1">
                ...
                >
                  <div className="space-y-2">
                    ...
                    <p className="text-[10px] text-muted-foreground">
                      <span className="font-bold text-foreground">Motivo:</span> "{r.justificativa}"
                    </p>
                  </div>
